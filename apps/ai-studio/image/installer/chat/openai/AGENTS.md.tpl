...
## Notes
- OpenAI Codex CLI is installed on first use via npm (`npm install -g @openai/codex`)
- Node.js 22 is installed as a runtime dependency for OpenAI Codex CLI
- The OPENAI_API_KEY can be injected from the container environment at startup
- This file is loaded from `~/.codex/AGENTS.md` (global context, always active regardless of working directory)
