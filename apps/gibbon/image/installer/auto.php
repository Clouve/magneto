...
$data['demoData'] = getenv('DEMO_DATA') ?: "N";

//admin user
$user_data['title'] = getenv('GIBBON_TITLE') ?: "Mr.";
$user_data['firstName'] = getenv('GIBBON_FIRSTNAME') ?: "ADMIN";
$user_data['surname'] = getenv('GIBBON_LASTNAME') ?: "ADMIN";
...
$user_data['timezone'] = getenv('GIBBON_TIMEZONE') ?: "America/Los_Angeles";
$user_data['country'] = getenv('GIBBON_COUNTRY') ?: "United States";
$user_data['currency'] = getenv('GIBBON_CURRENCY') ?: "USD $";
